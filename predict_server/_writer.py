...
class PerfMetricWriter(CsvWriter):
    ...
    def make_header_items(self):
        return [
            ...
            'predicted_left_projection_left',
            'predicted_left_projection_top',
            'predicted_left_projection_right',
            'predicted_left_projection_bottom',
            'predicted_right_projection_left',
            'predicted_right_projection_top',
            'predicted_right_projection_right',
            'predicted_right_projection_bottom',
            'overall_latency',
